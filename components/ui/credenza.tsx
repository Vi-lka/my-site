...
interface CredenzaTriggerProps extends BaseProps {
  className?: string
  asChild?: true
...
const CredenzaClose = ({ className, children, ...props }: CredenzaTriggerProps) => {
  const { isDesktop } = useCredenzaContext();
...
const CredenzaTitle = ({ className, children, ...props }: CredenzaProps) => {
  ...
  return (
    <CredenzaTitle className={cn("px-4 md:px-0", className)}  {...props}>
      {children}
    </CredenzaTitle>
  );
};
