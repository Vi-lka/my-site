...
export default function PageLayout({
  ...
  return (
    <div className={cn("relative flex flex-col items-center justify-center", className)}>
      ...
      {/* HUD-like elements */}
      <div className="fixed top-5 left-5 text-violet text-xs md:flex flex-col hidden z-0">
      ...
      <div className="fixed bottom-5 right-5 text-violet text-xs text-right md:flex flex-col hidden z-0">
        <GlitchText className="text-violet" classNameGlitch="text-background/60" classNameGlitch2="text-violet">
